    ...
    <div className='w-full h-[80px] bg-white border-b'>
        <div className='md:max-w-[1480px] max-w-[600px] m-auto w-full h-full flex justify-between items-center md:px-0 px-4'>
            ...
            <div className='hidden md:flex' >
                <button className='flex justify-between items-center bg-trasnparent px-6 gap-2'>
                    <img src={lock} />
                    Login
                </button>
        ...
        <div className={toggle?'absolute z-10 p-4 bg-white w-full  px-8 md:hidden':'hidden'}>
            <ul>
                    ...
                    <div className='flex flex-col my-4 gap-4'>
                        <button className='border border-[#20B486] flex justify-center items-center bg-trasnparent px-6 gap-2 py-4'>
                        <img src={lock} />
                        Login
                        </button>
