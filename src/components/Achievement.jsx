    ...
    <div className='w-full bg-white py-24'>
        <div className='md:max-w-[1480px] m-auto grid md:grid-cols-2 max-w-[600px]'>
          ...
          <div className='flex flex-col justify-center'>
              <h1 className='md:leadng-[72px]  text-3xl font-bold'>Our<span className='text-[#20B486]'> Achievements</span></h1>
              ...
              <div className='grid grid-cols-2 py-16'>
                 ...
                 <div className='py-6 flex '>
                    <div className='p-4 bg-[#FFEEF0] rounded-2xl'>
                        <SlGraduation
                        size={30}
                        style={{color:'#ED4459'}}
                        />
                 ...
                 <div className='py-6 flex '>
                    <div className='p-4 bg-[#F0F7FF] rounded-2xl'>
                        <LuUsers2 
                        size={30}
                        style={{color:'#0075FD'}}
                        />
